---
title: "How to Tell Your Children You Are Getting Divorced"
seoTitle: How to Tell Your Children About Divorce | Age-by-Age Guide for UK Parents
description: How to tell your children about divorce. Age-by-age scripts, common mistakes to avoid, and expert advice for UK parents breaking the news.
date: 2026-04-10
type: article
tags:
  - divorce
...
Research confirms that it is not the divorce itself that causes the most harm to children. It is how parents handle the transition. A [meta-analysis published in Clinical Psychology Review](https://www.sciencedirect.com/science/article/pii/S0272735820300490){target="_blank" rel="noopener noreferrer"} ↗, covering over 24,000 families, found that parental conflict is a stronger predictor of children's difficulties than the separation itself. How you tell your children sets the tone for everything that follows.
...
Your children will look to you for cues on how to react. If you are overwhelmed, they will feel overwhelmed too. This does not mean you need to be emotionless. Showing some sadness is honest and healthy. But if you are still in the acute stage of grief, anger, or shock, consider working through those feelings with a [divorce coach](/divorce-coaching-vs-counselling-what-s-the-difference/) or counsellor before having this conversation.
...
<svg viewBox="0 0 700 480" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Chart showing common children's reactions to divorce news by age group: sadness, anger, self-blame, withdrawal, and anxiety. Horizontal grouped bar chart with four age bands per reaction.">
  <title>Common Children's Reactions to Divorce News by Age Group</title>
  <rect width="700" height="480" fill="#f8f9fa" rx="8"/>
  <text x="350" y="30" text-anchor="middle" font-family="system-ui, sans-serif" font-size="15" font-weight="bold" fill="#1e293b">Common Children's Reactions to Divorce News by Age Group</text>
  <text x="350" y="48" text-anchor="middle" font-family="system-ui, sans-serif" font-size="11" fill="#94a3b8">Relative likelihood of each reaction (illustrative, based on developmental research)</text>

  <!-- Sadness group -->
  <text x="118" y="82" text-anchor="end" font-family="system-ui, sans-serif" font-size="12" fill="#475569">Sadness</text>
  <rect x="125" y="65" width="260" height="11" rx="2" fill="#93c5fd"/>
  <rect x="125" y="78" width="320" height="11" rx="2" fill="#60a5fa"/>
  <rect x="125" y="91" width="240" height="11" rx="2" fill="#3b82f6"/>
  <rect x="125" y="104" width="160" height="11" rx="2" fill="#1d4ed8"/>

  <!-- Anger group -->
  <text x="118" y="152" text-anchor="end" font-family="system-ui, sans-serif" font-size="12" fill="#475569">Anger</text>
  <rect x="125" y="135" width="80" height="11" rx="2" fill="#93c5fd"/>
  <rect x="125" y="148" width="140" height="11" rx="2" fill="#60a5fa"/>
  <rect x="125" y="161" width="340" height="11" rx="2" fill="#3b82f6"/>
  <rect x="125" y="174" width="400" height="11" rx="2" fill="#1d4ed8"/>

  <!-- Self-blame group -->
  <text x="118" y="222" text-anchor="end" font-family="system-ui, sans-serif" font-size="12" fill="#475569">Self-Blame</text>
  <rect x="125" y="205" width="60" height="11" rx="2" fill="#93c5fd"/>
  <rect x="125" y="218" width="380" height="11" rx="2" fill="#60a5fa"/>
  <rect x="125" y="231" width="200" height="11" rx="2" fill="#3b82f6"/>
  <rect x="125" y="244" width="60" height="11" rx="2" fill="#1d4ed8"/>

  <!-- Withdrawal group -->
  <text x="118" y="292" text-anchor="end" font-family="system-ui, sans-serif" font-size="12" fill="#475569">Withdrawal</text>
  <rect x="125" y="275" width="120" height="11" rx="2" fill="#93c5fd"/>
  <rect x="125" y="288" width="100" height="11" rx="2" fill="#60a5fa"/>
  <rect x="125" y="301" width="280" height="11" rx="2" fill="#3b82f6"/>
  <rect x="125" y="314" width="380" height="11" rx="2" fill="#1d4ed8"/>

  <!-- Anxiety group -->
  <text x="118" y="362" text-anchor="end" font-family="system-ui, sans-serif" font-size="12" fill="#475569">Anxiety</text>
  <rect x="125" y="345" width="320" height="11" rx="2" fill="#93c5fd"/>
  <rect x="125" y="358" width="280" height="11" rx="2" fill="#60a5fa"/>
  <rect x="125" y="371" width="240" height="11" rx="2" fill="#3b82f6"/>
  <rect x="125" y="384" width="180" height="11" rx="2" fill="#1d4ed8"/>

  <!-- Legend -->
  <rect x="140" y="440" width="14" height="14" rx="2" fill="#93c5fd"/>
  <text x="160" y="452" font-family="system-ui, sans-serif" font-size="11" fill="#475569">Toddlers (2-4)</text>
  <rect x="270" y="440" width="14" height="14" rx="2" fill="#60a5fa"/>
  <text x="290" y="452" font-family="system-ui, sans-serif" font-size="11" fill="#475569">Young children (5-7)</text>
  <rect x="430" y="440" width="14" height="14" rx="2" fill="#3b82f6"/>
  <text x="450" y="452" font-family="system-ui, sans-serif" font-size="11" fill="#475569">Pre-teens (8-12)</text>
  <rect x="140" y="460" width="14" height="14" rx="2" fill="#1d4ed8"/>
  <text x="160" y="472" font-family="system-ui, sans-serif" font-size="11" fill="#475569">Teenagers (13-17)</text>
</svg>
...
- If your child is struggling, organisations like [YoungMinds](https://www.youngminds.org.uk/parent/parents-a-z-mental-health-guide/divorce-and-separation/){target="_blank" rel="noopener noreferrer"} ↗ offer guidance for parents supporting children's mental health through separation
- Begin working on a [co-parenting plan](/co-parenting-after-divorce-a-practical-guide-for-uk-parents/) if you have not already; structure and predictability are your children's greatest allies
...
[Gingerbread](https://www.gingerbread.org.uk/){target="_blank" rel="noopener noreferrer"} ↗, the charity for single-parent families, also offers advice and support for parents navigating separation with children.
...
- Build a [co-parenting plan](/co-parenting-after-divorce-a-practical-guide-for-uk-parents/) that prioritises your children's needs
- Navigate difficult reactions from your children or your ex-partner
- [Rebuild your own confidence](/rebuilding-confidence-after-divorce-support-groups-counselling-and-self-help-strategies/) so you can show up as the parent your children need

If you are facing this conversation and want support, [book a free discovery call](/book-a-free-call/) to talk through your situation with a professional who understands what you are going through.
...
- [Co-Parenting After Divorce: A Practical Guide for UK Parents](/co-parenting-after-divorce-a-practical-guide-for-uk-parents/)
- [Rebuilding Confidence After Divorce](/rebuilding-confidence-after-divorce-support-groups-counselling-and-self-help-strategies/)
- [How Do I Get a Divorce?](/how-do-i-get-a-divorce/)
- [No Fault Divorce Reform in the UK](/no-fault-divorce-reform-in-the-uk/)
- [How Much Does a Divorce Coach Cost in the UK?](/how-much-does-a-divorce-coach-cost-in-the-uk/)
- [Divorce Advice for Men UK](/divorce-advice-for-men-uk/)
